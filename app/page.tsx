...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background border-border backdrop-blur-sm bg-background/95 border-b shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <Link href="/auth/login">
            <Button className="bg-primary hover:bg-primary/90 text-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl shadow-primary/30 px-6">
              Get Started
            </Button>
          </Link>
        </div>
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 overflow-hidden md:py-[180px]">
      ...
      {/* Footer */}
      <footer className="border-t border-border shadow-sm bg-[rgba(255,250,236,1)]">
