...
1. Sign up at [https://www.plancktechnologies.xyz](https://www.plancktechnologies.xyz)
...
user = PlanckUser(
    ...
    base_url="https://www.plancktechnologies.xyz"  # Optional, this is the default
)
...
client = PlanckClient(
    ...
    base_url="https://www.plancktechnologies.xyz",  # Optional
